...
def computer_guess():
    ...
    while True:
        ...
        if user_guess > Number:
            ...
            print(f"Correct! It took you {turns} turns to guess the correct answer")
            break
...
def user_guess():
    ...
    while True:
        ...
        response = input(f"Is your number {guess_int} | If yes then enter 'c' | If no then enter 'H' for higher and 'L' for lower than your number: ")
